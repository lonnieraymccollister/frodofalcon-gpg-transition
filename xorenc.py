...
# generate otpkey with random data
newfile = open("keyotp.txt", "wb")
newfile.write (os.urandom(int(os.path.getsize(sys.argv[1])+10)))    # generate x 1 byte random content file
newfile.close ()
